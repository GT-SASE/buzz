...
type AlertDialogPrimitiveProps = React.ComponentProps<
  typeof AlertDialogPrime.Root
>;
...
function AlertDialogCancelPrimitive(props: AlertDialogCancelPrimitiveProps) {
  return <AlertDialogPrime.Cancel data-slot="alert-dialog-cancel" {...props} />;
}
...
function AlertDialogActionPrimitive(props: AlertDialogActionPrimitiveProps) {
  return <AlertDialogPrime.Action data-slot="alert-dialog-action" {...props} />;
}
...
function AlertDialogTitlePrimitive(props: AlertDialogTitlePrimitiveProps) {
  return <AlertDialogPrime.Title data-slot="alert-dialog-title" {...props} />;
}
