...
function SheetPrimitive(props: SheetPrimitiveProps) {
  ...
  return (
    <SheetProvider value={{ isOpen, setIsOpen }}>
      <SheetPrime.Root data-slot="sheet" {...props} onOpenChange={setIsOpen} />
    </SheetProvider>
  );
}

type SheetTriggerPrimitiveProps = React.ComponentProps<
  typeof SheetPrime.Trigger
>;
...
type SheetContentPrimitiveProps = React.ComponentProps<
  typeof SheetPrime.Content
> &
  HTMLMotionProps<"div"> & {
    side?: Side;
  };
...
function SheetDescriptionPrimitive(props: SheetDescriptionPrimitiveProps) {
  return <SheetPrime.Description data-slot="sheet-description" {...props} />;
}
