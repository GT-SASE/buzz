    ...
    <html lang="en" className={`${inter.variable} ${display.variable}`}>
      <body className="text-ink bg-paper flex min-h-screen flex-col antialiased">
        ...
        <a
          id="skip-to-content"
          href="#content"
          className="focus:bg-navy sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[60] focus:rounded-full focus:px-5 focus:py-2 focus:text-sm focus:font-semibold focus:text-white"
        >
          Skip to content
        </a>
        <SiteNav />
