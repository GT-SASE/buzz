...
function DropdownMenuTriggerPrimitive(
  props: DropdownMenuTriggerPrimitiveProps,
) {
  return (
    <DropdownMenuPrime.Trigger data-slot="dropdown-menu-trigger" {...props} />
  );
}
...
function DropdownMenuGroupPrimitive(props: DropdownMenuGroupPrimitiveProps) {
  return <DropdownMenuPrime.Group data-slot="dropdown-menu-group" {...props} />;
}
...
function DropdownMenuRadioGroupPrimitive(
  props: DropdownMenuRadioGroupPrimitiveProps,
) {
  return (
...
type DropdownMenuSubContentPrimitiveProps = Omit<
  ...
  "forceMount" | "asChild"
> &
  Omit<React.ComponentProps<typeof DropdownMenuPrime.Portal>, "forceMount"> &
  HTMLMotionProps<"div">;
...
function DropdownMenuHighlightItemPrimitive(
  props: DropdownMenuHighlightItemProps,
) {
...
function DropdownMenuLabelPrimitive(props: DropdownMenuLabelPrimitiveProps) {
  return <DropdownMenuPrime.Label data-slot="dropdown-menu-label" {...props} />;
}
...
function DropdownMenuSeparatorPrimitive(
  props: DropdownMenuSeparatorPrimitiveProps,
) {
  return (
...
function DropdownMenuShortcutPrimitive(
  props: DropdownMenuShortcutPrimitiveProps,
) {
...
function DropdownMenuItemIndicatorPrimitive(
  props: DropdownMenuItemIndicatorPrimitiveProps,
) {
  return (
