...
function PopoverPortalPrimitive(props: PopoverPortalPrimitiveProps) {
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <PopoverPrime.Portal forceMount data-slot="popover-portal" {...props} />
      )}
    </AnimatePresence>
  );
}
...
type PopoverAnchorPrimitiveProps = React.ComponentProps<
  typeof PopoverPrime.Anchor
>;

export function PopoverAnchorPrimitive({
  ...props
}: PopoverAnchorPrimitiveProps) {
...
type PopoverClosePrimitiveProps = React.ComponentProps<
  typeof PopoverPrime.Close
>;
